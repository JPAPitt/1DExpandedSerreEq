...
#Calculate coefficients 4th order approximation to second derivative
# need 6 locations for method, but one will be 0 due to cancellation, leaving
#the expected 5 function evalutions, of the cell centered approach
expandloc = symbols('x_{j}')
evallocs = [-2*h,-h,0,h,2*h,3*h]
desiredorder = 4
desiredderiv =2
...
display(DerivApproximation[2])
display(DerivApproximation[3])
